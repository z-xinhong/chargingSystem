...
export const selectScheduleMode = (mode) => post(`/schedule/mode?mode=${encodeURIComponent(mode)}`);
export const createScheduleBulkRequests = (payload) => post('/schedule/bulk-requests', payload);
